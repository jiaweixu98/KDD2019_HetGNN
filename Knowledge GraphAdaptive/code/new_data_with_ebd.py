...
PID_set = paper_author.keys() & paper_bioentity.keys() & paper_ebd.keys()
...
for k,v in paper_new_citation.items():
    paper_c2citation_c[PID_trans_Pcount[k]] = list(map(lambda x: PID_trans_Pcount[x],v))
...
p_abstract_embed = open("../data/academic/p_abstract_embed.txt", "w")
