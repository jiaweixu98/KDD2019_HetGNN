...
def read_args():
	...
	parser.add_argument('--data_path', type = str, default = '../data/academic_test/',
				   help='path to data')
	parser.add_argument('--A_n', type = int, default = 776653,
				   help = 'number of author node')
	parser.add_argument('--P_n', type = int, default = 455203,
				   help = 'number of paper node')
	parser.add_argument('--V_n', type = int, default =  547385,
				   help = 'number of bioentity node')
...
class paper:
	def __init__(self, title, author_list, time, bioentity, index, reference, abstract):
		self.title = title
